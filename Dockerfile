# Builds a Docker image for the Novostoic Frontend
#
# Usage:
#     docker build --secret id=NPMRC,src=$HOME/.npmrc -t moleculemaker/novostoic-frontend .
#
...
COPY --from=build /usr/local/app/dist/novostoic /usr/share/nginx/html/
